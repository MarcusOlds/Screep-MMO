...
var roleDropHarvester = {
    ...
    run: function(creep) {
        ...
        if(creep.harvest(Game.getObjectById(harvestSource)) == ERR_NOT_ENOUGH_RESOURCES){
            if(Game.getObjectById(harvestSource).ticksToRegeneration > 20 && creep.ticksToLive <= 1300){
